...
var questions = [
    ...
    new Question("ACCORDING TO THE TEXT, YOU SHOULD:", 
	["Not search a suspect unless you have reason to believe he/she has a weapon.", "Search all suspects immediately.","Search only persons suspected of major crimes.", "Search only those persons with a police record."], 
	"Not search a suspect unless you have reason to believe he/she has a weapon."),
    new Question("WHAT MUST YOU DO BEFORE YOU FRISK A SUSPECT?", 
	["Handcuff the suspect.", "Arrest the suspect.","Tie the suspect’s hands over his head.", "Write you a report."], 
	"Arrest the suspect."),
	new Question("A FRISK BY A SECURITY GUARD/PROPRIETARY PRIVATE SECURITY OFFICER IS A SEARCH FOR:", 
	["Weapons only.", "Stolen property only.","Weapons or stolen property.", "Anything."], 
	"Weapons only.")
	];
